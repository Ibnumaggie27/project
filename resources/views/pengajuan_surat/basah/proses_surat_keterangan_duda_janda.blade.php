...
@section('content')
    ...
    [&>div>textarea]:text-secondary [&>div>textarea]:rounded-lg [&>div>textarea]:text-sm [&>div>textarea]:block [&>div>textarea]:w-full [&>div>textarea]:border [&>div>textarea]:shadow-sm ">
            @csrf
            @method('PUT')
            <h1 class="text-2xl my-8">Proses Surat Keterangan Duda Janda</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="ttl"
                        ...
                        placeholder="Tempat / Tgl. Lahir" value="{{ old('ttl', $surat->ttl) }}" />
                    @error('ttl')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="keterangan_status"
                        ...
                        placeholder="Keterangan Status Pernikahan" value="{{ old('keterangan_status', $surat->keterangan_status) }}" />
